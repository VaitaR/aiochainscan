"""Deprecated facade functions for backward compatibility.

All functions in this module create and destroy HTTP clients on every call,
defeating connection pooling. Users should migrate to :class:`ChainscanClient`.

These functions are lazily loaded from ``aiochainscan.__init__`` via PEP 562
...
from aiochainscan.services.block import get_block_by_number, normalize_block
...
from aiochainscan.services.logs import normalize_logs
