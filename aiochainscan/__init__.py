...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    # --- DTOs (all Pydantic from dto_v2) ---
    'AddressBalanceDTO': ('aiochainscan.domain.dto_v2', 'BalanceDTO'),
    'BeaconWithdrawalDTO': ('aiochainscan.domain.dto_v2', 'BeaconWithdrawalDTO'),
    'BlockDTO': ('aiochainscan.domain.dto_v2', 'BlockDTO'),
    'DailySeriesDTO': ('aiochainscan.domain.dto_v2', 'DailySeriesDTO'),
    'EthPriceDTO': ('aiochainscan.domain.dto_v2', 'EthPriceDTO'),
    'GasOracleDTO': ('aiochainscan.domain.dto_v2', 'GasOracleDTO'),
    'InternalTxDTO': ('aiochainscan.domain.dto_v2', 'InternalTransactionDTO'),
    'LogEntryDTO': ('aiochainscan.domain.dto_v2', 'LogEventDTO'),
    'MinedBlockDTO': ('aiochainscan.domain.dto_v2', 'MinedBlockDTO'),
    'NormalTxDTO': ('aiochainscan.domain.dto_v2', 'TransactionDTO'),
    'ProxyTxDTO': ('aiochainscan.domain.dto_v2', 'TransactionDTO'),
    'TokenTransferDTO': ('aiochainscan.domain.dto_v2', 'TokenTransferDTO'),
    'TransactionDTO': ('aiochainscan.domain.dto_v2', 'TransactionDTO'),
    'TokenBalanceDTO': ('aiochainscan.services.token', 'TokenBalanceDTO'),
    # --- V2 DTOs (kept as named aliases for backwards compat) ---
