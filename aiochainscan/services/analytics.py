...
async def transactions_to_dataframe(
    transactions: list[dict] | AsyncIterator[dict],
) -> "pl.DataFrame":
    """
    ...
    for tx in tx_list:
        ...
        normalized.append({
            ...
            "from_address": from_addr.get("hash") if isinstance(from_addr, dict) else from_addr,
...
async def token_portfolio_to_dataframe(tokens: list[dict]) -> "pl.DataFrame":
    """
