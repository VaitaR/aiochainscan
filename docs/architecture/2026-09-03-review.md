...
- `aiochainscan/decode.py:157-185` (five fastabi bindings with zero callers)
...
`_abi_index` already computed that exact serialization for its digest. Five dead bindings
