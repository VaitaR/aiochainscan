...
**Base:** `b282054` (all eight pass-1 candidates merged, `make ci-local` green, 1500 tests).
...
**Status: done** — merged to `main` as `7a7bdc1` (2026-09-03), gate PASS-WITH-FINDINGS
...
MEDIUM closed in a fix round (lane commit `10d31fb`): `_event_signature_map` deleted
...
**Status: done** — merged to `main` as `750bf55` (2026-09-03), gate **PASS, zero
...
**Status: done** — merged to `main` as `7e54a55` (2026-09-03), gate PASS-WITH-FINDINGS
(2 LOW: `normalize_items`'s dict-with-`items` unwrap divergence — unreachable for every
scanner serving the twins, noted in the lane commit `a66af82`; `contract_address` wrap
untested — note only).
